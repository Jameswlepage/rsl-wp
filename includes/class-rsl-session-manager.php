...
class RSL_Session_Manager {
	 ...
	 */
	public function create_session( $license, $client, $options = array() ) {
	 ...
	 * @return bool
	 */
	public function update_session_status( $session_id, $status, $data = array() ) {
		$updates = array_merge( array( 'status' => $status ), $data );
