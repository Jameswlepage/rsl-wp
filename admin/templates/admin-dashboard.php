...
/** @var int    $total_licenses */
/** @var int    $active_licenses */
/** @var int    $global_license_id */
/** @var array  $licenses */

$screen = function_exists("get_current_screen") ? get_current_screen() : null;
$screen_id = $screen ? $screen->id : "rsl-dashboard";
?>
<div class="wrap rsl-wrap" data-screen-id="<?php echo esc_attr($screen_id); ?>">

  <h1 class="wp-heading-inline">
    <img src="<?php echo esc_url(
        RSL_PLUGIN_URL . "admin/images/rsl-logo.png",
    ); ?>" alt="RSL" class="rsl-admin-icon" />
    <?php esc_html_e("RSL Licensing", "rsl-wp"); ?>
  </h1>
  <a href="<?php echo esc_url(
      admin_url("admin.php?page=rsl-add-license"),
  ...
  <?php if (isset($_GET["settings-updated"])): ?>
    <div class="notice notice-success is-dismissible"><p><?php esc_html_e(
          ...
          <div class="rsl-at-glance-row">
            ...
            <div class="main">
              <ul>
                <li class="page-count">
                  <a href="<?php echo esc_url(
                      admin_url("admin.php?page=rsl-licenses"),
                  ); ?>">
                    <?php echo esc_html((string) $total_licenses); ?>
                  </a>
                  <?php echo esc_html(
                      _n("License", "Licenses", $total_licenses, "rsl-wp"),
                  ); ?>
                </li>
                <li class="post-count">
                  <?php echo esc_html((string) $active_licenses); ?>
                  <?php esc_html_e("Active", "rsl-wp"); ?>
                </li>
                <li class="comment-count">
                  <span class="<?php echo $global_license_id > 0
                      ? "approved"
                      : "pending"; ?>">
            ...
            <div class="rsl-quick-actions">
              <div class="rsl-action-buttons">
                ...
                <a href="<?php echo esc_url(
                    admin_url("admin.php?page=rsl-settings"),
                ); ?>" class="button">
                  <span class="dashicons dashicons-admin-settings"></span>
                  <?php esc_html_e("Settings", "rsl-wp"); ?>
                </a>
                <a href="https://rslstandard.org" target="_blank" rel="noopener noreferrer" class="button">
                  <span class="dashicons dashicons-external"></span>
                  <?php esc_html_e("RSL Standard", "rsl-wp"); ?>
                </a>
              </div>
            </div>
          </div><!-- /.rsl-at-glance-row -->
        </div><!-- /.inside -->
      </div><!-- /.postbox -->
    </div><!-- /.rsl-col-12 -->
          ...
          <table class="widefat striped">
            <tbody>
              <tr>
                ...
                <td>
                  <span class="<?php echo get_option(
                      "rsl_enable_html_injection",
                      1,
                  )
                      ? "yes"
                      : "no"; ?>">
                    <?php echo get_option("rsl_enable_html_injection", 1)
                        ? esc_html__("Enabled", "rsl-wp")
                        : esc_html__("Disabled", "rsl-wp"); ?>
                  </span>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <span class="<?php echo get_option(
                      ...
                      ? "yes"
                      : "no"; ?>">
                    <?php echo get_option("rsl_enable_http_headers", 1)
                        ? esc_html__("Enabled", "rsl-wp")
                        : esc_html__("Disabled", "rsl-wp"); ?>
                  </span>
                </td>
              ...
              <tr>
                ...
                <td>
                  <span class="<?php echo get_option("rsl_enable_robots_txt", 1)
                      ? "yes"
                      : "no"; ?>">
                    <?php echo get_option("rsl_enable_robots_txt", 1)
                        ? esc_html__("Enabled", "rsl-wp")
                        : esc_html__("Disabled", "rsl-wp"); ?>
                  </span>
                </td>
              ...
              <tr>
                ...
                <td>
                  <span class="<?php echo get_option("rsl_enable_rss_feed", 1)
                      ? "yes"
                      : "no"; ?>">
                    <?php echo get_option("rsl_enable_rss_feed", 1)
                        ? esc_html__("Enabled", "rsl-wp")
                        : esc_html__("Disabled", "rsl-wp"); ?>
                  </span>
                </td>
              ...
              <tr>
                ...
                <td>
                  <span class="<?php echo get_option(
                      ...
                      ? "yes"
                      : "no"; ?>">
                    <?php echo get_option("rsl_enable_media_metadata", 1)
                        ? esc_html__("Enabled", "rsl-wp")
                        : esc_html__("Disabled", "rsl-wp"); ?>
                  </span>
                </td>
              ...
              <tr>
                ...
                <td>
                  <?php if (class_exists("WooCommerce")): ?>
                    ...
                    <?php else: ?>
                      <br><small style="color: #856404;"><?php esc_html_e(
                          "Subscriptions: Extension needed",
                          "rsl-wp",
                      ); ?></small>
                    <?php endif; ?>
                  <?php else: ?>
                    <span class="no">✗ <?php esc_html_e(
                        "Not installed",
                        "rsl-wp",
                    ); ?></span>
                    <br><small><?php esc_html_e(
                        "Required for paid licensing",
                        "rsl-wp",
                    ); ?></small>
                  <?php endif; ?>
                </td>
    ...
    <div class="rsl-col-6">
      <div id="rsl-about" class="postbox">
        ...
        <div class="inside">
          <p>
            <?php esc_html_e(
                "Really Simple Licensing (RSL) is a machine-readable format for defining licensing terms for digital content. It enables content owners to specify how their content can be used by AI systems, search engines, and other automated tools.",
                "rsl-wp",
            ); ?>
          </p>
          <p>
            ...
            <a href="https://rslcollective.org" target="_blank" rel="noopener noreferrer" class="button rsl-button-gap">
