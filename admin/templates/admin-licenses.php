...
jQuery(document).ready(function($) {
    // Generate XML functionality
    $('.rsl-generate-xml').on('click', function() {
    ...
    $('.rsl-delete-license').on('click', function() {
        var licenseId = $(this).data('license-id');
        var licenseName = $(this).data('license-name');
        
        if (confirm('<?php _e('Are you sure you want to delete the license "', 'rsl-licensing'); ?>' + licenseName + '"?')) {
            $.ajax({
                url: rsl_ajax.url,
                type: 'POST',
                data: {
    ...
    // Modal functionality
    $('.rsl-modal-close').on('click', function() {
        $('.rsl-modal').hide();
    });
    ...
    // Copy to clipboard
    $('#rsl-copy-xml').on('click', function() {
        var textarea = document.getElementById('rsl-xml-content');
        textarea.select();
        document.execCommand('copy');
        alert('<?php _e('XML copied to clipboard!', 'rsl-licensing'); ?>');
    });
    
    // Download XML
    $('#rsl-download-xml').on('click', function() {
